...
def find_grid_id(row, grid_institutions_df: DataFrame):
...
def add_column_to_data(column_values_list : list, column_name: str, df: DataFrame, file_path: str):
    """
    Adds a list of values as a DataFrame column
    """
...
def lambda_handler(event, context) -> dict:
    ...
    df['identity'] = df.apply(find_grid_id, args=(grid_institutions_df,), axis=1)
